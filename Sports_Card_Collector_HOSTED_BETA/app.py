...
def analyze_card(front, back=None):
    content = [{
        ...
        "text": (
                ...
                "For the year field, return a year only when the actual release year is explicitly printed or clearly identified on the card. Do NOT use a copyright year as the release year unless the card explicitly identifies it that way. If the release year cannot be determined directly from the card, return year as an empty string rather than guessing. "
